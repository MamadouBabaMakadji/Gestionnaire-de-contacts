...
<body>
	...
	<div class="list-group">
		<a href="FormNewContact.jsp" class="list-group-item"><img
			src="images/newContact.png" />
		<bean:message key="main.nouveau.contact" /></a> <a
			href="FormEditContact.jsp" class="list-group-item"><img
			src="images/edit-contact.png" />
		<bean:message key="modifier.contact" /></a> <a href="FormSuppContact.jsp"
			class="list-group-item"><img src="images/delete.png" />
		<bean:message key="main.supprimer.contact" /></a> <a href="#"
			class="list-group-item"><img src="images/chercher-contact.png" />
		<bean:message key="main.rechercher.contact" /> <html:errors /> <html:form
