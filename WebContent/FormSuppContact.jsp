...
<br/>
	...
	<div class ="w3-container w3-black">
		<center><h1> <bean:message key="main.supprimer.contact" /></h1></center>
	</div>
...
<%
		...
		Connection connect = null;
				...
				while(rs.next()){
					...
					out.print("<tr><td>"+name+"</td><td>"+first_name+"</td><td>"+mail+"</td><td><a href='SuppContact.jsp?id="+id+"'>Supprimer</a></td></tr>");
				}
%>
