...
String login="root";
String mdp="root";
String requete = "select * from contact,adress,phonenumber,list_group_contact l "
				+"where contact.id='"+id+"' and adress.id='"+id+"' and phonenumber.id='"+id+"'";
...
try{
	...
	while(rs.next())
	{
		...
		String group = rs.getString("nameGroup");
...
%>
<h2>
<center><bean:message key="modifier.contact"/></center>
</h2>
...
<tr>
	...
	<tr>
	  <td><bean:message key="group" /></td><td><br/><html:text property="group" value="${group}"/><br/><br/></td>
	</tr>
	...
	<td>
	<br/>
	<html:submit><bean:message key="enreg.modif" /></html:submit>
	</td>
	</tr>
</table>
</html:form>
