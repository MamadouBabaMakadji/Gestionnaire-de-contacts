...
<body onload="noDisplay()">
	...
	<h2>
		<center>
			<bean:message key="FormNewContact.nouveau.contact" />
		</center>
		<br>
	</h2>
	<html:errors />
		...
		<table align="center">
			...
			<tr>
				...
				<td><br /> <input type="submit" class="btn btn-primary"
					value=" <bean:message key="enregistrer" />" /> <input type="reset"
					class="btn btn-primary" value="<bean:message key="annuler" />" />
				</td>
			</tr>
		</table>
	</html:form>
